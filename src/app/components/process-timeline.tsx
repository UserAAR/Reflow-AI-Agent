...
export function ProcessTimeline() {
  return (
    <section id="workflow" className="py-16 sm:py-20 lg:py-28 border-t border-black/[0.06] dark:border-white/[0.08] bg-neutral-50 dark:bg-neutral-950">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 sm:mt-16 relative">
          {/* line — hidden on mobile for clean look */}
          <div className="absolute left-0 right-0 top-[28px] h-px bg-gradient-to-r from-transparent via-black/10 to-transparent hidden lg:block" />

          <div className="relative grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-y-8 sm:gap-y-10">
            {steps.map((s, i) => (
              <div key={s.label} className="flex flex-col items-center text-center">
                <div className="relative w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-white dark:bg-neutral-900 border border-black/[0.06] dark:border-white/[0.08] shadow-[0_8px_24px_-16px_rgba(0,0,0,0.2)] flex items-center justify-center text-neutral-700 dark:text-neutral-300">
                ...
                <div className="mt-2.5 sm:mt-3 text-neutral-900 dark:text-neutral-100 px-1 sm:px-2" style={{ fontSize: "clamp(11px, 1vw, 12.5px)", fontWeight: 550, letterSpacing: "-0.005em" }}>
                  {s.label}
                </div>
              </div>
            ))}
